...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', default='/root/songbing/InterGPS-main/data/geometry3k')
    parser.add_argument('--ocr_path', default='/root/songbing/InterGPS-main/diagram_parser/detection_results/ocr_results')
    parser.add_argument('--box_path', default='/root/songbing/InterGPS-main/diagram_parser/detection_results/box_results')
