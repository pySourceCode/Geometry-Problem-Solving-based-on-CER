...
import sys
sys.path.append("/root/songbing/InterGPS-main/symbolic_solver")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--diagram_gt', default='/root/songbing/InterGPS-main/data/geometry3k/logic_forms/diagram_logic_forms_annot.json')
    parser.add_argument('--diagram_test', default='/root/songbing/InterGPS-main/diagram_parser/diagram_logic_forms.json')
