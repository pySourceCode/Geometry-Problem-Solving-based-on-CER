...
class LogicSolver:
    ...
    def Solve_Equations(self):
        ...
        solutions1_ = [sol for sol in solutions1 if not any(         #any用于判断给定的迭代参数是否全为false，有一个true则返回true
    ...
    def func1_direct_triangle_sum_theorem(self):        #内角和
        Update = False
    ...
    def func4_isosceles_triangle_theorem_angle(self):        #等腰三角形
    ...
    def Search(self, target, order_list=None, round_limit=5):
        """
