...
def one_try(try_id):
    try:
        ...
        with Pool(cpu_cores) as p:
            solve_list = p.map(solve, lst)  # multiple processing pools for 'solve' over 'lst'，pool多进程求值
        ...
        assert len(solved_list) == len(solved_correct_list) + len(solved_wrong_list)           #assert断言，判断是否相等
...
if __name__ == '__main__':
    ...
    DATA_INPUT_PATH = 'D:/ACL/InterGPS-main/data/geometry3k'
    DIAGRAM_INPUT_PATH = 'D:/ACL/InterGPS-main/data/geometry3k/logic_forms/diagram_logic_forms_annot.json'
    TEXT_INPUT_PATH = 'D:/ACL/InterGPS-main/data/geometry3k/logic_forms/text_logic_forms_annot_dissolved.json'
    PREDICT_STEP_PATH = 'D:/ACL/InterGPS-main/theorem_predict/results/train/pred_seqs_train_l30_n100_template.json'

    OUTPUT_PATH = 'D:/ACL/InterGPS-main/theorm_predict/results/train/splits'
    LOG_PATH = 'D:/ACL/InterGPS-main/theorm_predict/results/train/logs'
